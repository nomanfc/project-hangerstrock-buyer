                  ...
                  <s.td>
                    <s.actionCon>
                      {row.original.is_published === 1 ? (
                        <Tooltip title="UnPublish" aria-label="approve">
                          <IconButton onClick={props.handleAppUnPub({ row })}>
                            <UnpublishedIcon
                              style={{
                                color: "red",
                              }}
                        ...
                        <Tooltip title="Publish" aria-label="approve">
                          <IconButton onClick={props.handleAppPub({ row })}>
